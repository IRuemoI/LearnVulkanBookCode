...
void ShaderQueueSuit_DoubleTexLight::createUniformBuffer(VkDevice& device,
...
ShaderQueueSuit_DoubleTexLight::ShaderQueueSuit_DoubleTexLight(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                               VkPhysicalDeviceMemoryProperties& memoryProperties)
{
