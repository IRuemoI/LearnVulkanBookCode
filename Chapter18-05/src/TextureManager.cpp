                                  ...
                                  VkQueue& queueGraphics)
{
    ...
    for (int i = 0; i < texNames.size(); i++)
    {
        ...
        if (needStaging)
        {
            ...
            vkCmdCopyImage(cmdBuffer, textureImageListHelp[texNames[i]], VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
                           textureImageList[texNames[i]], VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &copy_region);
