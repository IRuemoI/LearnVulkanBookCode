...
void VulkanDemoApp::createDrawableObject()
{
    ...
    trWater = new TextureRect(VertData::vdata, VertData::dataByteCount, VertData::vCount, VertData::indexData,
...
void VulkanDemoApp::drawThings()
{
    ...
    woodObjForDraw->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                             &(sqsCL->descSet[
                                 TextureManager::getVkDescriptorSetIndex("../textures/1311_stuff01.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
