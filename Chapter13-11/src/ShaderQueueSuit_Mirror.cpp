...
void ShaderQueueSuit_Mirror::create_uniform_buffer_vert(VkDevice& device,
...
/*创建片元着色器一致变量数据缓冲*/
void ShaderQueueSuit_Mirror::create_uniform_buffer_frag(VkDevice& device,
                                                        VkPhysicalDeviceMemoryProperties& memoryProperties)
{
...
ShaderQueueSuit_Mirror::ShaderQueueSuit_Mirror(VkDevice* deviceIn, VkRenderPass& renderPass,
                                               VkPhysicalDeviceMemoryProperties& memoryProperties)
{
