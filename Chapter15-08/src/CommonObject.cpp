...
CommonObject::CommonObject(float* vdataIn, int dataByteCount, int vCountIn, VkDevice& device,
...
void CommonObject::drawSelf(VkCommandBuffer& cmd, VkPipelineLayout& pipelineLayout, VkPipeline& pipeline,
