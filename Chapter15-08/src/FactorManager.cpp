...
void FactorManager::setFactorValue(float startXIn, float endXIn, float startYIn, float endYIn, float startZIn,
                                   float endZIn, float detailDepthIn, float LFactorIn)
{
    startX = startXIn;
    endX = endXIn;
    startY = startYIn;
