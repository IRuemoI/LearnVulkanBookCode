...
void Quaternion::setToRotateAboutAxis(Vector3f* axis, float theta)
{
    //构造绕指定轴旋转指定角四元数的方法
...
void Quaternion::getRotationAxis(Vector3f* axis)
{
    //提取旋转轴的方法
...
void Quaternion::cross(Quaternion* a, Quaternion* result)
{
    //实现四元数叉乘运算的方法
