...
void VulkanDemoApp::createDrawableObject()
{
    ...
    ballForDraw = new TexLightObject(BallData::vdata, BallData::dataByteCount, BallData::vCount, device,
                                     memoryProperties);
    BallData::genBallData(3, 30.2);
    cloudBallForDraw = new TexLightObject(BallData::vdata, BallData::dataByteCount, BallData::vCount, device,
                                          memoryProperties);
    SkyData::genSkyData(400);
    skyForDrawBig = new ColorObject(SkyData::vdata, SkyData::dataByteCount, SkyData::vCount, device, memoryProperties,
                                    4.0f);
    SkyData::genSkyData(1600);
    skyForDrawSmall = new ColorObject(SkyData::vdata, SkyData::dataByteCount, SkyData::vCount, device, memoryProperties,
                                      2.0f);
}
...
void VulkanDemoApp::flushUniformBuffer() const
{
    //将当前帧的一致变量数据送入一致变量缓冲的方法
