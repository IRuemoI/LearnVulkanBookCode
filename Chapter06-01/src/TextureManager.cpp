...
void TextureManager::init_SPEC_2D_Textures(const std::string& texName, VkDevice& device, VkPhysicalDevice& gpu,
                                  ...
                                  VkQueue& queueGraphics)
{
    ...
    for (int i = 0; i < texNames.size(); i++)
    {
        ...
        init_SPEC_2D_Textures(texNames[i], device, gpu, memoryProperties, cmdBuffer, queueGraphics,
                              VK_FORMAT_R8G8B8A8_UNORM, ctdo); //加载 2D 纹理
    }
}
