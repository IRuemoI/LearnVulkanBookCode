...
void VulkanDemoApp::createDrawableObject()
{
    ...
    colorRectG = new DrawableObjectCommon(ColorRect::vdataG, ColorRect::dataByteCount, ColorRect::vCount, device,
                                          memoryProperties);
    colorRectR = new DrawableObjectCommon(ColorRect::vdataR, ColorRect::dataByteCount, ColorRect::vCount, device,
                                          memoryProperties);
}
