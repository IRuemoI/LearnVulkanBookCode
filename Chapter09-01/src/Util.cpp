...
void mouse_button_callback(GLFWwindow* window, int button, int action, int mods)
{
    ...
    else if (button == GLFW_MOUSE_BUTTON_LEFT && action == GLFW_RELEASE)
    {
        ...
        if (preX > 0 && preX < VulkanDemoApp::screenWidth / 2 && preY > 0 && preY < VulkanDemoApp::screenHeight / 2)
        {
            //左上部分
            VulkanDemoApp::direction += VulkanDemoApp::DEGREE_SPAN;
        }
        else if (preX > 0 && preX < VulkanDemoApp::screenWidth / 2 && preY > VulkanDemoApp::screenHeight / 2 && preY <
            VulkanDemoApp::screenHeight)
        {
            //左下部分
            VulkanDemoApp::Offset += 0.5;
        }
        else if (preX > VulkanDemoApp::screenWidth / 2 && preX < VulkanDemoApp::screenWidth && preY > 0 && preY <
            VulkanDemoApp::screenHeight / 2)
        {
            //右上部分
            VulkanDemoApp::direction -= VulkanDemoApp::DEGREE_SPAN;
        }
        else if (preX > VulkanDemoApp::screenWidth / 2 && preX < VulkanDemoApp::screenWidth && preY >
            VulkanDemoApp::screenHeight / 2 && preY < VulkanDemoApp::screenHeight)
        {
            //右下部分
            VulkanDemoApp::Offset -= 0.5;
        }
