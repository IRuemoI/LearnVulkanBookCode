...
void VulkanDemoApp::createDrawableObject()
{
    ...
    beltForDraw = new DrawableObjectCommonLight(BeltData::vdata, BeltData::dataByteCount, BeltData::vCount, device,
                                                memoryProperties);
    CircleData::genVertexData();
    cirForDraw = new DrawableObjectCommonLight(CircleData::vdata, CircleData::dataByteCount, CircleData::vCount, device,
                                               memoryProperties);
}
