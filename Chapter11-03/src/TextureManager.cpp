...
std::vector<std::string> TextureManager::texNames = {
    "../textures/1103_treetrunk.bntex", "../textures/1103_leaf.bntex", "../textures/1103_water.bntex",
    "../textures/1103_sky.bntex", "../textures/1103_caodi.bntex", "../textures/1103_sand.bntex"
};
