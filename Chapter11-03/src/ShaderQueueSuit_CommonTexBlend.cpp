...
void ShaderQueueSuit_CommonTexBlend::createUniformBuffer(VkDevice& device,
...
ShaderQueueSuit_CommonTexBlend::ShaderQueueSuit_CommonTexBlend(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                               VkPhysicalDeviceMemoryProperties& memoryProperties)
{
