...
TexLeafDrawableObject::TexLeafDrawableObject(float* vdataIn, int dataByteCount, int vCountIn, VkDevice& device,
                                             VkPhysicalDeviceMemoryProperties& memoryProperties, float pxIn, float pyIn,
                                             float pzIn, float tangle, float idIn)
{
...
void TexLeafDrawableObject::drawSelf(VkCommandBuffer& cmd, VkPipelineLayout& pipelineLayout, VkPipeline& pipeline,
