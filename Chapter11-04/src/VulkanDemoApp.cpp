...
{
    std::vector<float> tVectorA = LoadUtil::loadFromFileVertexAndTex("../models/1104_laoying01.obj");
    //加载关键帧1 模型的顶点坐标和纹理坐标
...
void VulkanDemoApp::drawObject()
{
    ...
    LYobjDraw1->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                         &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1104_laoying.bntex")]));
