...
void ShaderQueueSuit_CommonTex_X::createUniformBuffer(VkDevice& device,
...
ShaderQueueSuit_CommonTex_X::ShaderQueueSuit_CommonTex_X(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                         VkPhysicalDeviceMemoryProperties& memoryProperties)
{
