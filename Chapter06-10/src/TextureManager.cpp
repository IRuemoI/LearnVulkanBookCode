...
void convertImageLayout(VkCommandBuffer cmd, VkImage image, VkImageAspectFlags aspectMask,
                        VkImageLayout old_image_layout, VkImageLayout new_image_layout, int32_t layerCount) //设置图像布局的方法
{
                                  ...
                                  VkQueue& queueGraphics)
{
    ...
    for (int i = 0; i < texNames.size(); i++)
    {
        ...
        init_SPEC_2DArray_Textures(texNames[i], device, gpu, memoryProperties, cmdBuffer, queueGraphics,
                                   VK_FORMAT_R8G8B8A8_UNORM, ctdo);
    }
}

void TextureManager::init_SPEC_2DArray_Textures(std::string texName, VkDevice& device, VkPhysicalDevice& gpu,
                                                ...
                                                TexArrayDataObject* ctdo)
{
    ...
    convertImageLayout(cmdBuffer, textureImage, VK_IMAGE_ASPECT_COLOR_BIT, VK_IMAGE_LAYOUT_UNDEFINED,
                       VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, ctdo->length);
    ...
    convertImageLayout(cmdBuffer, textureImage, VK_IMAGE_ASPECT_COLOR_BIT, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                       VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, ctdo->length);
