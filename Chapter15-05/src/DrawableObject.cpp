...
DrawableObject::DrawableObject(float* vdataIn, int dataByteCount, int vCountIn, VkDevice& device,
...
void DrawableObject::drawSelf(VkCommandBuffer& cmd, VkPipelineLayout& pipelineLayout, VkPipeline& pipeline,
