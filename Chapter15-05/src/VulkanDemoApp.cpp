...
void VulkanDemoApp::createDrawableObject()
{
    ...
    sky = new DrawableObject(SkyCloudData::vdata, SkyCloudData::dataByteCount, SkyCloudData::vCount, device,
                             memoryProperties);
}
...
void VulkanDemoApp::flushTexToDesSetForToTex()
{
    ...
    for (int i = 0; i < TextureManager::texNamesForCommonTexLight.size(); i++)
    {
        ...
        sqsCTLB->writes[1].pImageInfo = &(TextureManager::texImageInfoList[TextureManager::texNamesForCommonTexLight[
            i]]);
...
void VulkanDemoApp::drawSceneToTex()
{
    ...
    drawForWindow->drawSelf(cmdBuffer, sqsCTLB->pipelineLayout, sqsCTLB->pipeline,
                            &(sqsCTLB->descSet[TextureManager::getVkDescriptorSetIndexForCommonTexLight(
                                tp + (string)("window.bntex"))]));
