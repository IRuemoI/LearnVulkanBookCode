...
void ShaderQueueSuit_Light::initDescriptorSet(VkDevice& device)
{
    //初始化描述集的方法
    ...
    positionImageInfo = descriptorImageInfo(VK_NULL_HANDLE, VulkanDemoApp::colorImageView[1],
                                            VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
    ...
    normalImageInfo = descriptorImageInfo(VK_NULL_HANDLE, VulkanDemoApp::colorImageView[2],
                                          VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
...
ShaderQueueSuit_Light::ShaderQueueSuit_Light(VkDevice* deviceIn, VkRenderPass& renderPass,
