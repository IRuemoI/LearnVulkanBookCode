...
void ShaderQueueSuit_CommonQiu::createUniformBuffer(VkDevice& device,
...
ShaderQueueSuit_CommonQiu::ShaderQueueSuit_CommonQiu(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                     VkPhysicalDeviceMemoryProperties& memoryProperties)
{
