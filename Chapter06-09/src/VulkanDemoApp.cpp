...
void VulkanDemoApp::createDrawableObject()
{
    ...
    texBall = new TexDrawableObject(BallData::vdata, BallData::dataByteCount, BallData::vCount, device,
                                    memoryProperties);
}
...
void VulkanDemoApp::drawObject()
{
    ...
    texBall->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                      &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/0609_boardRed.bn3dtex")]));
    ...
    texBall->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                      &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex(
                          "../textures/0609_boardGreen.bn3dtex")]));
