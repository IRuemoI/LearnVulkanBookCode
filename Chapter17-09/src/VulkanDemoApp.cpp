...
void VulkanDemoApp::drawObject()
{
    ...
    for (auto planeP : planeVector)
    {
        ...
        for (int i = 0; i < planeP->count; i++)
        {
            ...
            MatrixState3D::translate(planeP->curPosition[i * 4 + 0], planeP->curPosition[i * 4 + 1],
                                     planeP->curPosition[i * 4 + 2]);
