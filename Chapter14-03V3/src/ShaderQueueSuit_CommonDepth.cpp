...
void ShaderQueueSuit_CommonDepth::createUniformBuffer(VkDevice& device,
...
ShaderQueueSuit_CommonDepth::ShaderQueueSuit_CommonDepth(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                         VkPhysicalDeviceMemoryProperties& memoryProperties)
{
