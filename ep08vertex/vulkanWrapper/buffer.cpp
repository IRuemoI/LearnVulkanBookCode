...
namespace FF::Wrapper
{
    ...
    Buffer::Buffer(const Device::Ptr& device, VkDeviceSize size, VkBufferUsageFlags usage,
    ...
    {
        auto stageBuffer = Buffer::create(mDevice, size, VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
