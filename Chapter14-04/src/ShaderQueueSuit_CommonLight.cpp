...
void ShaderQueueSuit_CommonLight::create_uniform_buffer_vert(VkDevice& device,
...
/*创建片元着色器一致变量数据缓冲*/
void ShaderQueueSuit_CommonLight::create_uniform_buffer_frag(VkDevice& device,
                                                             VkPhysicalDeviceMemoryProperties& memoryProperties)
{
...
ShaderQueueSuit_CommonLight::ShaderQueueSuit_CommonLight(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                         VkPhysicalDeviceMemoryProperties& memoryProperties)
{
