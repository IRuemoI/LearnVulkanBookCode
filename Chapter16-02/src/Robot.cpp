...
Robot::Robot(vector<ObjObject*> objObject)
{
    ...
    printf("[Robot: 开始调用initFratherMatrix...]\n");
    bRoot->initFratherMatrix();
    printf("[Robot: initFratherMatrix完成]\n");
    printf("[Robot: 开始调用updateBone...]\n");
    bRoot->updateBone();
    printf("[Robot: updateBone完成]\n");
    printf("[Robot: 开始调用calMWorldInitInver...]\n");
    bRoot->calMWorldInitInver();
    printf("[Robot: calMWorldInitInver完成]\n");
}
