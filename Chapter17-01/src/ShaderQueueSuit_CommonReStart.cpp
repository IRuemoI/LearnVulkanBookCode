...
void ShaderQueueSuit_CommonReStart::createUniformBuffer(VkDevice& device,
...
ShaderQueueSuit_CommonReStart::ShaderQueueSuit_CommonReStart(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                             VkPhysicalDeviceMemoryProperties& memoryProperties)
{
