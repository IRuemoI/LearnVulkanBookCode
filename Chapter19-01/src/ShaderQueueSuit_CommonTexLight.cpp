...
#define VK_DYNAMIC_STATE_RANGE_SIZE 8

static inline void init_glslang()
{
    glslang::InitializeProcess();
}

static inline void finalize_glslang()
{
    glslang::FinalizeProcess();
}

//Uniform Buffer
void ShaderQueueSuit_CommonTexLight::create_uniform_buffer(VkDevice& device,
                                                           VkPhysicalDeviceMemoryProperties& memoryroperties)
{
    ...
    if (flag) { printf("234234234ª%d\n", alloc_info.memoryTypeIndex); }
    else { printf("2344234234\n"); }
...
{
    std::string vertStr = FileUtil::loadAssetStr(VertShaderPath);
    std::string fragStr = FileUtil::loadAssetStr(FragShaderPath);
    init_glslang();
...
ShaderQueueSuit_CommonTexLight::ShaderQueueSuit_CommonTexLight(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                               VkPhysicalDeviceMemoryProperties& memoryroperties)
{
