...
//Uniform Buffer
void ShaderQueueSuit_Dashboard2D::create_uniform_buffer(VkDevice& device,
...
{
    std::string vertStr = FileUtil::loadAssetStr(VertShaderPath2);
    std::string fragStr = FileUtil::loadAssetStr(FragShaderPath2);
    init_glslang();
...
ShaderQueueSuit_Dashboard2D::ShaderQueueSuit_Dashboard2D(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                         VkPhysicalDeviceMemoryProperties& memoryroperties)
{
