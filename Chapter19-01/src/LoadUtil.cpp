                                  ...
                                  VkPhysicalDeviceMemoryProperties& memoryroperties)
{
    ...
    {
        vdataIn[indexTemp++] = alvResult[i * 3 + 0]; //¶¥µãx×ø±ê
        vdataIn[indexTemp++] = alvResult[i * 3 + 1]; //¶¥µãy×ø±ê
        vdataIn[indexTemp++] = alvResult[i * 3 + 2]; //¶¥µãz×ø±ê

        vdataIn[indexTemp++] = altResult[i * 2 + 0]; //ÎÆÀís×ø±ê
        vdataIn[indexTemp++] = altResult[i * 2 + 1]; //ÎÆÀís×ø±ê

        vdataIn[indexTemp++] = alnResult[i * 3 + 0]; //·¨ÏòÁ¿x·ÖÁ¿
        vdataIn[indexTemp++] = alnResult[i * 3 + 1]; //·¨ÏòÁ¿y·ÖÁ¿
        vdataIn[indexTemp++] = alnResult[i * 3 + 2]; //·¨ÏòÁ¿z·ÖÁ¿
    }
