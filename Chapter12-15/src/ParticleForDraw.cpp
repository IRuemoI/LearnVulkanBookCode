...
ParticleForDraw::ParticleForDraw(float* vdataIn, int dataByteCount, int vCountIn, VkDevice& device,
...
void ParticleForDraw::drawSelf(VkCommandBuffer& cmd, VkPipelineLayout& pipelineLayout, VkPipeline& pipeline,
                               VkDescriptorSet* desSetPointer, int id)
{
    ...
    vkCmdPushConstants(cmd, pipelineLayout, VK_SHADER_STAGE_FRAGMENT_BIT, 128, sizeof(float) * 9,
                       pushConstantData + 32);
