...
void VertexDataForDraw::updateVertex_0()
{
    ...
    {
        this->initVec->setXYZ(this->position_init[i * 3 + 0], this->position_init[i * 3 + 1],
                              this->position_init[i * 3 + 2]);
        for (int j = 0; j < 4; ++j)
        {
        ...
        this->tempL->interpolate_four(&this->vec[0], &this->vec[1], &this->vec[2], &this->vec[3],
