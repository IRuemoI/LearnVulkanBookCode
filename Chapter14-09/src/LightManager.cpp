...
void LightManager::setLightAmbient(int id, float lightAmbientRIn, float lightAmbientGIn, float lightAmbientBIn,
...
void LightManager::setLightDiffuse(int id, float lightDiffuseRIn, float lightDiffuseGIn, float lightDiffuseBIn,
...
void LightManager::setLightSpecular(int id, float lightSpecularRIn, float lightSpecularGIn, float lightSpecularBIn,
