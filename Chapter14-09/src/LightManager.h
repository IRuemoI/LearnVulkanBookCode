...
public:
    ...
    static void setLightAmbient(int id, float lightAmbientRIn, float lightAmbientGIn, float lightAmbientBIn,
                                float lightAmbientAIn);
    static void setLightDiffuse(int id, float lightDiffuseRIn, float lightDiffuseGIn, float lightDiffuseBIn,
                                float lightDiffuseAIn);
    static void setLightSpecular(int id, float lightSpecularRIn, float lightSpecularGIn, float lightSpecularBIn,
