...
void ShaderQueueSuit_CommonEdge::createUniformBuffer(VkDevice& device,
...
ShaderQueueSuit_CommonEdge::ShaderQueueSuit_CommonEdge(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                       VkPhysicalDeviceMemoryProperties& memoryProperties)
{
