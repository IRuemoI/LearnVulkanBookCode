...
void VulkanDemoApp::drawObject()
{
    ...
    texTri->drawSelf(cmdBuffer, sqsImage->pipelineLayout, sqsImage->pipeline,
                     &(sqsImage->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1203_pm.bntex")]));
    MatrixState3D::translate(-6.6f, 0, 0); //正常图像
    texTri->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                     &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1203_pm.bntex")]));
