...
void VulkanDemoApp::mainLoop()
{
    ...
    isDrawTask0ThreadShouldClose = isDrawTask1ThreadShouldClose = isDrawTask2ThreadShouldClose =
        isDrawTask3ThreadShouldClose = true;
}
...
void VulkanDemoApp::drawSpec3D(SCBArangeThreadTask* stta, float pyx, float pyy, float pyz, float scx, float scy,
                               float scz, ObjObject* oo, std::string texName, float* currMatrix, float* MVP)
{
...
void VulkanDemoApp::drawTask0(SCBArangeThreadTask* stta)
{
    while (!isDrawTask0ThreadShouldClose)
    {
        ...
        for (int i = 0; i < planePosition0->count; i++)
        {
            //循环绘制一组飞船
            drawSpec3D(stta, planePosition0->curPosition[i * 4 + 0], planePosition0->curPosition[i * 4 + 1],
                       planePosition0->curPosition[i * 4 + 2], 0.2, 0.2, 0.2, objObject, "plane01.bntex",
                       stta->currMatrix, stta->MVP);
        }
...
void VulkanDemoApp::drawTask1(SCBArangeThreadTask* stta)
{
    while (!isDrawTask1ThreadShouldClose)
    {
        ...
        {
            drawSpec3D(stta, planePosition1->curPosition[i * 4 + 0], planePosition1->curPosition[i * 4 + 1],
                       planePosition1->curPosition[i * 4 + 2], 0.2, 0.2, 0.2, objObject1, "plane02.bntex",
                       stta->currMatrix, stta->MVP);
        }
        stta->closeAfterDraw();
...
void VulkanDemoApp::drawTask2(SCBArangeThreadTask* stta)
{
    while (!isDrawTask2ThreadShouldClose)
    {
        ...
        {
            drawSpec3D(stta, planePosition2->curPosition[i * 4 + 0], planePosition2->curPosition[i * 4 + 1],
                       planePosition2->curPosition[i * 4 + 2], 0.2, 0.2, 0.2, objObject2, "plane03.bntex",
                       stta->currMatrix, stta->MVP);
        }
        stta->closeAfterDraw();
        stta->doTaskFlag = true;
...
void VulkanDemoApp::drawTask3(SCBArangeThreadTask* stta)
{
    while (!isDrawTask3ThreadShouldClose)
    {
        ...
        {
            drawSpec3D(stta, planePosition3->curPosition[i * 4 + 0], planePosition3->curPosition[i * 4 + 1],
                       planePosition3->curPosition[i * 4 + 2], 0.2, 0.2, 0.2, objObject3, "plane04.bntex",
                       stta->currMatrix, stta->MVP);
        }
        stta->closeAfterDraw();
        stta->doTaskFlag = true;
