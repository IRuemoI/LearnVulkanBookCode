...
void ShaderQueueSuit_DoubleTex::createUniformBuffer(VkDevice& device,
...
ShaderQueueSuit_DoubleTex::ShaderQueueSuit_DoubleTex(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                     VkPhysicalDeviceMemoryProperties& memoryProperties)
{
