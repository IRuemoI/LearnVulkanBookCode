...
void VulkanDemoApp::createDrawableObject()
{
    ...
    texForDraw = new TexDrawableObject(RectData::vData, RectData::dataByteCount, RectData::vCount, device,
                                       memoryProperties);
    VertData::genVertData();
    waterForDraw = new TexLightObject(VertData::vdata, VertData::dataByteCount, VertData::vCount, VertData::indexData,
                                      VertData::indexDataByteCount, VertData::indexCount, device, memoryProperties);
...
void VulkanDemoApp::drawTask()
{
    ...
    texForDraw->drawSelf(cmdBuffer, sqsTex->pipelineLayout, sqsTex->pipeline,
                         &(sqsTex->descSet[TextureManager::getVkDescriptorSetIndexForSkyBox(
    ...
    waterForDraw->drawSelf(cmdBuffer, sqsSTL->pipelineLayout, sqsSTL->pipeline,
                           &(sqsSTL->descSet[TextureManager::getVkDescriptorSetIndexForCubemap(
    ...
    objPool->drawSelf(cmdBuffer, sqsLoad->pipelineLayout, sqsLoad->pipeline,
                      &(sqsLoad->descSet[TextureManager::getVkDescriptorSetIndexForSkyBox(
