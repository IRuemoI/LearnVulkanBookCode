                                  ...
                                  VkQueue& queueGraphics)
{
    ...
    for (int i = 0; i < texNames.size(); i++)
    {
        ...
        if (sa[1].compare("bntex") == 0)
        {
            ...
            init_SPEC_2D_Textures(texName, device, gpu, memoryroperties, cmdBuffer, queueGraphics,
        ...
        else if (sa[1].compare("bntexcube") == 0)
        {
            ...
            initCubemapTextures(texName, device, gpu, memoryroperties, cmdBuffer, queueGraphics,
                                VK_FORMAT_R8G8B8A8_UNORM, ctdo);
        }
    }
}
