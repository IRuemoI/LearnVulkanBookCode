...
void VulkanDemoApp::createDrawableObject()
{
    ...
    texTri = new TexDrawableObject(FlatData::vdata, FlatData::dataByteCount, FlatData::vCount, device,
                                   memoryProperties);
}
...
void VulkanDemoApp::drawObject()
{
    ...
    texTri->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                     &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1207_object.bntex")]));
    MatrixState3D::translate(6.6f, 0, 0);
    texTri->drawSelf(cmdBuffer, sqsImage->pipelineLayout, sqsImage->pipeline,
                     &(sqsImage->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1207_object.bntex")]));
    MatrixState3D::translate(0, -6.6f, 0);
    texTri->drawSelf(cmdBuffer, sqsImage->pipelineLayout, sqsImage->pipeline,
                     &(sqsImage->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1207_object1.bntex")]));
    MatrixState3D::translate(-6.6f, 0, 0);
    texTri->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                     &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/1207_object1.bntex")]));
