...
void ShaderQueueSuit_ForCalAoFactor::createUniformBuffer(VkDevice& device,
...
ShaderQueueSuit_ForCalAoFactor::ShaderQueueSuit_ForCalAoFactor(VkDevice* deviceIn, VkRenderPass& renderPass,
                                                               VkPhysicalDeviceMemoryProperties& memoryProperties)
{
