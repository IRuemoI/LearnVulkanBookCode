...
ObjObjectQiu::ObjObjectQiu(float* vdataIn, int dataByteCount, int vCountIn, VkDevice& device,
...
void ObjObjectQiu::drawSelf(VkCommandBuffer& cmd, VkPipelineLayout& pipelineLayout, VkPipeline& pipeline,
