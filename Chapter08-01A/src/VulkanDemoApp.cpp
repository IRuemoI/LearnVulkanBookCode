...
void VulkanDemoApp::createDrawableObject()
{
    ...
    texRect = new TexDrawableObject(RectData::vdata, RectData::dataByteCount, RectData::vCount, device,
                                    memoryProperties);
...
void VulkanDemoApp::drawObject()
{
    ...
    texRect->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                      &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("../textures/0801A_lgq.bntex")]));
    MatrixState3D::popMatrix();
    MatrixState3D::popMatrix();
