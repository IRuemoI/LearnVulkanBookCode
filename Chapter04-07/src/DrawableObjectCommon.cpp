...
DrawableObjectCommon::DrawableObjectCommon(float* vdataIn, int dataByteCount, int vCountIn, VkDevice& device,
...
void DrawableObjectCommon::drawSelf(VkCommandBuffer& cmd, VkPipelineLayout& pipelineLayout, VkPipeline& pipeline,
