...
void VulkanDemoApp::flushTexToDesSet()
{
    ...
    for (int i = 0; i < TextureManager::texNamesForCommonTexLight.size(); i++)
    {
        ...
        sqsDTL->writes[1].pImageInfo = &(TextureManager::texImageInfoList[TextureManager::texNamesForCommonTexLight[
            i]]);
...
void VulkanDemoApp::drawObject()
{
    ...
    if (pipeLineIndex == 0)
    {
        ...
        mountain->drawSelf(cmdBuffer, sqsDTL->pipelineLayout, sqsDTL->pipeline,
                           &(sqsDTL->descSet[TextureManager::getVkDescriptorSetIndexForCommonTexLight(
                               "../textures/1504_mountain.bntex")]));
    ...
    skyForDraw->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                         &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndexForCOmmonTex(
                             "../textures/1504_sky.bntex")]));
    MatrixState3D::popMatrix();
